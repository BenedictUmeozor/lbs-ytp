    ...
    >
      <div className="flex items-center gap-2 border-b border-border px-3 py-4 lg:px-4">
        ...
        <div className="hidden min-w-0 lg:block">
          <p className="truncate text-sm font-semibold text-foreground">Bariga Smart Waste</p>
          <p className="truncate text-xs text-muted-foreground">Bariga pilot · Proof of concept</p>
        </div>
      </div>
      ...
      <div className="mt-auto border-t border-border p-3 lg:p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden min-w-0 lg:block">
            ...
            <p className="truncate text-xs text-muted-foreground">Fleet manager</p>
          </div>
        </div>
      </div>
    </aside>
