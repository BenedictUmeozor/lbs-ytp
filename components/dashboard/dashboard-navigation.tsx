          ...
          return (
            <li key={href}>
              <Link
                ...
                className={cn(
                  "text-muted-foreground hover:bg-accent hover:text-accent-foreground focus-visible:ring-ring/50 flex items-center gap-3 rounded-md border-l-2 border-transparent px-2.5 py-2 text-sm transition-colors outline-none focus-visible:ring-3",
                  active &&
