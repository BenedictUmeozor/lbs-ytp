const LEGEND_ITEMS = [
  ...
  { color: "#7f1d1d", label: "Critical bin (ring pulse)", indicator: "marker" },
  ...
  { color: "#475569", label: "Numbered route stop", indicator: "marker" },
  { color: "#64748b", label: "Completed route stop", indicator: "marker" },
  { color: "#111827", label: "Selected marker outline", indicator: "marker" },
] as const;
