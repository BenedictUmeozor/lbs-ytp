...
const OperationsMapPreviewClient = dynamic(
  () =>
    import("@/components/maps/operations-map-preview-client").then(
      (mod) => mod.OperationsMapPreviewClient,
    ),
  {
    ssr: false,
...
export function OperationsMapPreview(props: OperationsMapPreviewProps) {
  return (
    <div
      className="h-72 w-full overflow-hidden rounded-lg lg:h-96"
      role="img"
      aria-label="Bariga pilot operations map preview"
    >
